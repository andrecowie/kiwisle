...
#### Ben
The teams final iteration showed clear improvement compared to the first iteration. Team had more frequent meetings, and more coordination in completeing the project. I believe team had some time getting accustomed to the project work style as it was our first/second time facing such project. Previously we had trouble allocating our time as we had other assignments due on the same week as our software engineering.But now we finished all other assignment and had time to finish our iteration 2 and 3 and i belive it is overall good iteration.
#### Alex
